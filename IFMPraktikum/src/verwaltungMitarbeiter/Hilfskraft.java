...
public class Hilfskraft extends Person {
	...
	public Hilfskraft(String surName, String firstName, String street, String city, int zip, int day, int month, int year, int hours) {
	...
	public double getNetto() {
		return TIMERATE_W * hours * FACTOR;
	}
